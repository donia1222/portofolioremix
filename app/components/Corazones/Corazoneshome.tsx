...
export default function AntennaWithWaves() {
  ...
  return (
    <div className="flex flex-col items-center  justify-center h-80 mb-40 mt-48">
      ...
      <h2 className="text-4xl font-bold text-pink-400 text-center  p-8" data-aos="fade-up ">
