    ...
    <div className="min-h-screen text-white">
      <header className="py-12 px-4 sm:px-6 lg:px-8 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-3xl sm:text-4xl md:text-4xl font-bold mb-4">Roberto Salvador</h1>
          <p className="text-xl sm:text-2xl md:text-3xl text-blue-500">Webentwickler & Mobile App Entwickler</p>
        </div>
      </header>
