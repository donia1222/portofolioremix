...
import { Download, Mail, Phone, Globe, MapPin, CreditCard, Code } from "lucide-react"
import VCardVersions from "./vcard-versions"
...
export default function VCardModul() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-blue-900 flex flex-col items-center justify-center p-4 pb-20">
      ...
      <motion.div
        className="bg-gray-800 rounded-xl shadow-2xl overflow-hidden max-w-4xl w-full border border-gray-700 mb-8 mt-20"
        ...
        <div className="p-8 md:p-12 grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <ul className="space-y-3 mb-8">
              {[
                { icon: <Download className="text-blue-400" />, text: "Einfacher Download der digitalen Visitenkarte" },
                {
    ...
    >
      ...
      >
        ...
        <p className="text-gray-300 mb-6">
          Unser vCard-Modul ist nicht nur auf Joomla beschränkt. Sie können jetzt die gleiche Funktionalität in Ihren
          Lieblingsprojekten genießen:
        </p>
